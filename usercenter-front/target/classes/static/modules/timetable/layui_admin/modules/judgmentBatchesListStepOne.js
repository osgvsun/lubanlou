...
layui.use(['laypage', 'layer', 'table', 'element', 'tableSelect'], function () {
    ...
    getTeacher();
    table.render({
        elem: '#judgmentBatchesListStepOne',
        id: 'judgmentBatchesListStepOne',
        title: '选择教师',
        cellMinWidth: 100,
        page: true, //开启分页
        ...
        if (teacherList != '') {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    added = teacherDatas;
                    table.reload('judgmentBatchesListStepOne', {data: teacherDatas});
                }
            });
        }
    ...
    form.on('submit(add_teacher)', function (data) {
        ...
        var cache = table.cache['judgmentBatchesListStepOne'];
        var t = {};
        ...
        $.ajax({
            ...
            success: function (res) {
                console.log(res);
                if(res.code == 0){
                    table.reload('judgmentBatchesListStepOne', {data: added});
                }
            }
        });
    ...
    //监听行工具事件
    table.on('tool(judgmentBatchesListStepOne)', function (obj) {
        var data = obj.data;
        if (obj.event === 'del') {
    ...
    var nextStep = {
        nextStep: function () {
             ...
             * */
            savePageInfoRedis()
            window.parent.window.judgmentBatchesCourseTwo(term, courseNo, teacherlist);

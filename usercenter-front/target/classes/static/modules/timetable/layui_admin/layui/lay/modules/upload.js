...
;layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            if(typeof uploadF !== "undefined" && uploadF == 'resource'){
                var formData=new FormData();
                formData.append('siteName', '实验室管理平台');
                formData.append('username', currentUsername);
                formData.append('directoryId', o.config.data.directoryId);
                formData.append('shareState','私有');
                for(var key in a){
                    formData.append('files',a[key]);
                    console.log(formData);
                }
                var ALLeIndex=new Array()

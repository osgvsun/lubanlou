layui.use(['form', 'element', 'laydate', 'laypage', 'table', 'layer'], function() {
	...
	var newauditfreelist = {
		newauditfreelist: function() {
			...
			var index = layer.open({
				...
				shade: 0.5,
				maxmin: true,
				content: '../access/newExamFreeList?entityId=' + labRoomId + '&entityType=' + configType + '&flag=0' + '&parentTable=auditfreelist',
	...
	table.render({
		...
		where: {"entityId": labRoomId, "entityType": configType, "accessEntityId": accessEntityId, "flag": 0},
		title: '列表',
		cellMinWidth: 100,
		page: true, //开启分页			

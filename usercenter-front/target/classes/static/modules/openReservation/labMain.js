layui.config({
	...
	function _domConcat(labObj) {
		let labUrl = location.origin + "/teacherInformationCenter/openReservation/labAppointment"
		let configTypeEnum = ["LAB"]
		...
		return `<div class="grid-item">
                    <div class="card_box">
                        ...
                        <div class="card_bottom">
                        	<label class="fl fa fa-question-circle gray_dot">${labObj['labRoomReservation'] == 1 ? '开放' : '未开放'}</label>
                            <div class="fr">
                                <a 
                                href="javascript:;" onclick="setLabRoomName(\'${_url(0)}\', ${labObj['labRoomReservation']})"

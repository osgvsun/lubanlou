	...
	table.on('tool(courseattendance)', function(obj) {
		...
		if(obj.event === 'attendance') {
			var index = layer.open({
				...
				shade: 0.5,
				maxmin: true,
				content: `courseAttendanceDetail?id=${obj.data.id}&classDate=${obj.data.classDate}&startTime=${obj.data.startTime}&endTime=${obj.data.endTime}&hardwareIps=${obj.data.hardwareIps}`,

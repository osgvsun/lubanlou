layui.use(['form', 'element', 'laydate', 'laypage', 'table', 'layer'], function() {
	...
	var newexamfreelist = {
		newexamfreelist: function() {
			...
			var index = layer.open({
				...
				shade: 0.5,
				maxmin: true,
				content: '../access/newExamFreeList?entityId=' + labRoomId + '&entityType=' + configType + '&flag=2' + '&parentTable=examfreelist',
	...
	table.render({
		...
		where: {"entityId": labRoomId, "entityType": configType, "accessEntityId": accessEntityId, "flag": 2},
		title: '列表',
		cellMinWidth: 100,
		page: true, //开启分页			

...
var zuulUrl ="";
var flag = 1;
var zuulServerUrl = $("#zuulServerUrl").val()+"/limsproduct/limsproduct";
...
function getJWTAuthority() {
    var authorization ="";
    initDirectoryEngine({
        getHostsUrl:zuulServerUrl+"/shareApi/getHosts",
        getAuthorizationUrl:zuulServerUrl+"/shareApi/getAuthorization"
    });
    getAuthorization({
        async:false,

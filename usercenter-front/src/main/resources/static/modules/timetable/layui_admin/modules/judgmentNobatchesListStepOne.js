...
layui.use(['laypage', 'layer', 'table', 'element'], function() {
    ...
    if (tag!=''){
        ...
        //展示已知数据
        table.render({
            elem: '#judgmentNobatchesListStepOne'
            ,page: true //开启分页
            ...
            ,data: timetabledatas,
            id: 'judgmentNobatchesListStepOne',
            // data: table,
            skin: 'line', //表格风格
            even: false,
            limits: [5, 7, 10, 20],
	...
	//监听行工具事件
	table.on('tool(judgmentNobatchesListStepOne)', function(obj) {
		var data = obj.data;
		if(obj.event === 'del') {
    ...
    var nextStep = {
        nextStep: function() {
            ...
            console.log(timetableClass);
            window.parent.window.judgmentNoBatchesCourseTwo(term,courseNo,timetableClass);
        }
    };

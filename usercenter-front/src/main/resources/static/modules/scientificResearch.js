                        ...
                        if(dataObject[i].config.adminSetting==1||dataObject[i].config.selfSetting==1){
                            ...
                            for (var j = 0; j < personTree.length; j++) {
                                if (personTree[j].config.adminSetting== "1"||personTree[j].config.selfSetting== "1") {
                                    ...
                                    var tableField=[{title:'序号', width:100, type:"numbers",align:'center'}] ;
                                    for (var k = 0; k < level3.length; k++) {
                                        if(level3[k].config.adminSetting==1||level3[k].config.selfSetting==1){
                                            tableField.push({field: level3[k].config.field, title:level3[k].config.name, align:'center',width:'150'});
                                    ...
                                    console.log(table1)
                                    if (table1 == 'user_longitudinal_subject_info') {
                                    ...
                                    if (table1 == 'user_horizontal_subject_info') {
                                        tableField.push({field: 'showFile', title: '立项文件',align: 'center', toolbar: '#showFile2',width:100});
                                    ...
                                    if (table1 == 'user_research_award_info') {
                                        tableField.push({field: 'showFile', title: '获奖证书',align: 'center', toolbar: '#showFile3',width:100});
                                    ...
                                    if (table1 == 'user_publication_info') {
                                        tableField.push({field: 'showFile', title: '书籍图片',align: 'center', toolbar: '#showFile4',width:200});
                                        tableField.push({fixed: 'right', title: '操作',align: 'center', toolbar: '#edit4',width:200});
                                        table.render({

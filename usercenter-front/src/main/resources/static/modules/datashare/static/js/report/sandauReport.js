...
function tableRender() {
    ...
    layui.use(['table'], function () {
        ...
        table.render({
            ...
            cols: [[
                // {type: 'checkbox', fixed: 'left'},
                {
                    ...
                    title: '课表',
                    align: 'center',
                    toolbar: '#term-timetable'
                }, {
                    title: '日历表',
                    align: 'center',
                    toolbar: '#term-calendartable'
                }, {
                    title: '进度表',
                    align: 'center',
                    toolbar: '#term-progress'
                }, {
                    title: '获取/更新排课数据',
                    align: 'center',
                    toolbar: '#term-sourcedata'
                }
        ...
        table.on('tool(lay_table_schoolTerm)', function (obj) {
            ...
            switch (obj.event) {
                case 'timetable':
                    window.open('luckySheet?lakeNumber=sandau&reportNumber=timetable&params='+data.termNumber, '在线报表')
                    break;
                case 'calendartable':
                    window.open('luckySheet?lakeNumber=sandau&reportNumber=calendartable&params='+data.termNumber, '在线报表')
                    break;
                case 'progress':
                    window.open('luckySheet?lakeNumber=sandau&reportNumber=progress&params='+data.termNumber, '在线报表')
                    break;
                case 'sourcedata':
                    $.ajax({
                        url: datashareHost + "putTimetableData",
                        data: {'termNumber': data.termNumber},
                        method: "post",

...
layui.use('upload', function () {
    ...
    upload.render({
        ...
        url: datashareHost + 'shared/uploadViewSchoolCourseDetailByExcel',
        data:{'isOther':0,'courseNo':courseNo},
        accept: 'file',
        exts: 'xlsx',
        before: function (res) {
            loading("数据导入中,请耐心等待......");
    ...
    upload.render({
        ...
        url: datashareHost + 'shared/uploadViewSchoolCourseDetailByExcel',
        data:{'isOther':1,'courseNo':courseNo},
        accept: 'file',
        exts: 'xlsx',
        before: function (res) {
            loading("数据导入中,请耐心等待......");

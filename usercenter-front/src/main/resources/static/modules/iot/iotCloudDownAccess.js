layui.use(['index', 'form', 'laypage', 'laydate', 'layer', 'table', 'element'], function() {
    ...
    form.render(null, 'iotclouddownaccess');
    ...
    //监听行工具事件
    table.on('tool(iotclouddownaccesstab)', function(obj) {
            ...
            $.ajax({
                ...
                success:function (s) {
                    if (s=="success") {
                        ...
                        table.reload('iotclouddownaccesstab');
                    }
                    else
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            form.render('select', "iotclouddownaccess");
        },
    })

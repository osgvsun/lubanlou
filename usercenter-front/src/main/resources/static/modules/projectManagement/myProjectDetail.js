layui.use(['form', 'element', 'laydate', 'laypage', 'table', 'layer', 'layedit', 'upload', 'util'], function() {
	...
	form.render(null, 'myprojectdetailbox');

	//信息
	form.val('myprojectdetailbox', {
		"name": "test1",
		"state": "test2",
		"lesson": "test3",
		"term": "test4",
	...
	table.render({
		...
		url: layui.setter.base + 'json/myProjectDetailMaterialUse.json', //数据接口
		title: '列表',
		cellMinWidth: 90,
		page: true, //开启分页			
	...
	table.render({
		...
		url: layui.setter.base + 'json/myProjectDetailEquipment.json', //数据接口
		title: '列表',
		cellMinWidth: 90,
		page: true, //开启分页			
		page: { //支持传入 laypage 组件的所有参数（某些参数除外，如：jump/elem） - 详见文档
	...
	table.render({
		...
		url: layui.setter.base + 'json/myProjectDetailEnclosure.json', //数据接口
		title: '列表',
		cellMinWidth: 90,
		page: true, //开启分页			
		page: { //支持传入 laypage 组件的所有参数（某些参数除外，如：jump/elem） - 详见文档

...
function saveExamResult() {
    ...
    $.ajax({
        type: 'POST',
        async: false,
        url: "../questionPool/saveExamResult?examId="+examId+"&username="+username+"&score="+score,
        success: function(data) {
            var index=parent.layer.getFrameIndex(window.name);
            parent.layer.close(index);
            window.parent.location.reload();
            /*window.location.href="../questionPool/getExamScore?currpage=1&testId="+examId;*/
            /*window.location.href="../system/examManagement"*/

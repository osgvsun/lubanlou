(function(i, f, c, k, d, l, h) {
    ...
    function() {
        ...
        g.Ib = function(b, a) {
            return function(c) {
                c = u(c);
                var e = c.type,
                    d = c.relatedTarget || (e == "mouseout" ? c.toElement: c.fromElement); (!d || d !== a && !g.ag(a, d)) && b(c)
            }
        };
        ...
        function hb(a, c, e) {
            var b = [];
            for (a = a ? a.firstChild: k; a; a = a.nextSibling) if (a.nodeType == 1) { (!c || a.tagName == c) && b.push(a);
                if (!e) {
                    var d = hb(a, c, e);
        ...
        g.Lb = function(b, a, c) { (c || a.parentNode).insertBefore(b, a)
        };
        g.Bb = function(b, a) {
            a = a || b.parentNode;
            a && a.removeChild(b)
        ...
        function Z(d, c, b) {
            var a = d.cloneNode(!c); ! b && g.Ng(a, "id");
            return a
        }
        g.T = Z;
        g.Eb = function(e, f) {
    ...
    var p = i.$JssorSlideshowFormations$ = new
    function() {
        var h = this,
            b = 0,
            a = 1,
        ...
        function o(B, h, a, w, o, m) {
            ...
            if (b.gb()) {
                var E = !h["no-image"],
                    A = b.qf(h);
                b.a(A,
                    function(a) { (E || a["jssor-slider"]) && b.Gb(a, b.Gb(a), d)
                    })
            }
            b.a(p,
                function(h, k) {
    ...
    var j = i.$JssorSlider$ = function(p, hc) {
        ...
        function rc(o, n) {
            ...
            b.Wc = function() {
                ...
                i = l;
                var a = w.ze();
                g.k(j.$EVT_SWIPE_END, t(w.Z()), w.Z()); ! a.Cb && Hc(a.xe, s)
            };
            b.dc = function(j, g) {
                var b;
                if (i) b = c;
        ...
        function Bc(i, f) {
            ...
            function G(d, g, l) {
                if (d == f) {
                    ...
                    var j = c.min(f, d),
                        i = c.max(f, d),
                        o = c.min(i - j, j + r - i),
                        n = u + a.$LazyLoading - 1; (!S || o <= n) && e.Eb()
                }
            }
            function bb() {
                if (s == f && h) {
            ...
            function Z(a) { ! M && g.k(j.$EVT_CLICK, f, a)
            }
            function Q() {
                p = v.pInstance;
                h && h.md(p)
        ...
        function Ib(a) { ! b.j(b.ec(a), "nodrag") && b.Jb(a)
        }
        function vc(a) {
            ac(a, 1)
        }
        ...
        if (r) {
            ...
            Gb(X());
            zb();
            a.$ArrowKeyNavigation && b.c(f, "keydown",
                function(b) {
    ...
    i.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        h.wc = function(b, d, f) {
            ...
            p = b;
            a != -1 && v[a].Ed();
            v[b].Ed(); ! f && s.$PlayTo(s.xd(c.floor(d / e)))
        };
        h.qc = function(a) {
            b.v(g, a)
        };

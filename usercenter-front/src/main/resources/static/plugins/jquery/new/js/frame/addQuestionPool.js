...
function show_sub(option){
    ...
    $(".choice_box").append("<div class='customInput'><button type='button' class='layui-btn layui-btn-primary' style='background: #f7f7f7 !important;line-height:32px !important;'>取消</button><button type=\"button\" onclick=\"select()\" class='layui-btn layui-btn-normal'>确定</button></div>")
...
function select(){
    ...
    /*$.ajax({
        ...
        data: {'type': type,'stem':stem,'answer':answer,'single':single,'answerLabelChoices':answerLabelChoices},

package net.gvsun.gsexam.constant;
...
public interface ConstantInterface {
    ...
    public String TEACHING_ACTIVITY_TYPE_ATTENDENCE = "attendence";
    ...
    /****************************************************************************
     * Description: 教学平台功能（Teaching Function） 模块{knowledge知识，skill技能，experience体验}
     *
     * @author:孟金城
     * @date : 2018-08-14
     ****************************************************************************/
    public String TEACHING_FUNCTION_MODULE_KNOWLEDGE = "knowledge";
    public String TEACHING_FUNCTION_MODULE_SKILL = "skill";
    public String TEACHING_FUNCTION_MODULE_EXPERIENCE = "experience";
    ...
    String TAssignmentItemMappingKey = "platform-teach-exam-TAssignmentItemMappingCache";

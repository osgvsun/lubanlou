...
public class TExperimentSkill implements Serializable {
	...
	@Column(name = "weight")
	BigDecimal weight;
	@Column(name = "to_addgrade")
	private  String toAddGrade;

	@Column(name="lesson_id")
	private Integer lessonId;

	@OneToMany(mappedBy="TExperimentSkill")
	...
	public String getToAddGrade() {
		return this.toAddGrade;
	}

	public void setToAddGrade(String addGrade) {
